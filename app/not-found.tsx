...
// Uncomment the following line if you need to use the `useView` context.
// import { useView } from "@/contexts/ViewContext";

const syne = Syne({ subsets: ["latin"] });

function NotFound() {
  // If you need to use the `useView` context, uncomment the following block.
  // const { setSectionInView } = useView();

  // useEffect(() => {
  //   setSectionInView(""); // Reset section view if applicable
  // }, []);
